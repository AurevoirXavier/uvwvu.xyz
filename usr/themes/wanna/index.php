                ...
                <div class="pageTag shadow-5">
                    ...
                    <div class="cardContent">
                        <div class="mdui-typo">
                            ...
                            <p style="font-size: 0.92em"><?php $this->excerpt(60,'...'); ?></p>
                        </div>
                        <div class="ovo">
                            <div class="ovo-icon">
                        ...
                        <div class="mdui-typo">
                            ...
                            <div class="sortBy">
                                <div>
                                    ...
                                    <button class="mdui-btn mdui-ripple flexTag" value="2">Reply</button>
                                </div>
                                <div>
                                    <button class="mdui-btn mdui-ripple flexTag" value="1">Article</button>
                                </div>
                                <div>
                                    <button class="mdui-btn mdui-ripple flexTag" value="0">Category</button>
                                </div>
                            </div>
