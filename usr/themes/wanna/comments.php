        ...
        <div class="mdui-row">
            <form method="post" action="<?php $this->commentUrl() ?>" style="width: 100%" role="form" id="comment_form">
                <?php if($this->user->hasLogin()): ?>
                    <p><?php _e('User: '); ?><a href="<?php $this->options->profileUrl(); ?>"><?php $this->user->screenName(); ?></a>. <a href="<?php $this->options->logoutUrl(); ?>" title="Logout"><?php _e('Sign out'); ?> &raquo; </a></p>
                <?php else: ?>
                ...
                <div class="mdui-col-xs-12 mdui-col-md-2" id="subBtn">
                    <button class="mdui-ripple" type="submit">Comment</button>
                </div>
            </form>
        </div>
        <?php else: ?>
    ...
    <div class="mdui-row comFiled">
        ...
        <div class="mdui-col-md-4 comTool">
            ...
            <div class="tags">
                ...
                <ul class="tags-list">
                    <?php while ($tags->next()): ?>
                        <li class="mdui-ripple"><a href="<?php $tags->permalink(); ?>" rel="tag" class="size-<?php $tags->split(5, 10, 20, 30); ?>" title="<?php $tags->count(); ?> topics"><?php $tags->name(); ?></a></li>
                    <?php endwhile; ?>
                    <?php else: ?>
